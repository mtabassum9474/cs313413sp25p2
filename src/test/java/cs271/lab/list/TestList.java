...
public class TestList {
  ...
  public void testRemoveObject() {
    ...
    list.add(77);
    list.add(6);
    list.remove(5); // TODO Question: What does this method do? removes the element at index 5 (not the value 5).
    // TODO fix the expected values in the assertions below
    ...
    assertEquals(77, list.get(3).intValue());
    list.remove(Integer.valueOf(5)); // TODO Question: What does this one do? removes the first occurrence of the value 5.
  ...
  public void testSet() {
    ...
    list.set(1, 99); // Change index 1 from 77 -> 99
    list.set(3, 99); // Change index 3 from 77 -> 99
    list.set(5, 99);
